...
for i, args in enumerate(utils.combinations):
    ...
    if i == 0:
        ...
        profiles_surface[0] = pg.analysis.profile_dens(s.gas, 'mass', r_edges=bins, proj=1)
        profiles_surface[1] = pg.analysis.profile_dens(s.gas[hot], 'mass', r_edges=bins, proj=1)
        profiles_surface[2] = pg.analysis.profile_dens(s.gas[~hot], 'mass', r_edges=bins, proj=1)
        profiles_surface[3] = pg.analysis.profile_dens(s.gas[m_rec], 'mass', r_edges=bins, proj=1)
        profiles_surface[4] = pg.analysis.profile_dens(s.gas[m_rec][hot], 'mass', r_edges=bins, proj=1)
        profiles_surface[5] = pg.analysis.profile_dens(s.gas[m_rec][~hot], 'mass', r_edges=bins, proj=1)
        profiles_surface[6] = pg.analysis.profile_dens(s.gas[m_nrec], 'mass', r_edges=bins, proj=1)
        profiles_surface[7] = pg.analysis.profile_dens(s.gas[m_nrec][hot], 'mass', r_edges=bins, proj=1)
        profiles_surface[8] = pg.analysis.profile_dens(s.gas[m_nrec][~hot], 'mass', r_edges=bins, proj=1)
        HI_profiles_surface[0] = pg.analysis.profile_dens(s.gas, 'HI', r_edges=bins, proj=1)
        HI_profiles_surface[1] = pg.analysis.profile_dens(s.gas[m_rec], 'HI', r_edges=bins, proj=1)
        HI_profiles_surface[2] = pg.analysis.profile_dens(s.gas[m_nrec], 'HI', r_edges=bins, proj=1)
        MgII_profiles_surface[0] = pg.analysis.profile_dens(s.gas, 'MgII', r_edges=bins, proj=1)
        MgII_profiles_surface[1] = pg.analysis.profile_dens(s.gas[m_rec], 'MgII', r_edges=bins, proj=1)
        MgII_profiles_surface[2] = pg.analysis.profile_dens(s.gas[m_nrec], 'MgII', r_edges=bins, proj=1)
        OVI_profiles_surface[0] = pg.analysis.profile_dens(s.gas, 'OVI', r_edges=bins, proj=1)
        OVI_profiles_surface[1] = pg.analysis.profile_dens(s.gas[m_rec], 'OVI', r_edges=bins, proj=1)
        OVI_profiles_surface[2] = pg.analysis.profile_dens(s.gas[m_nrec], 'OVI', r_edges=bins, proj=1)
    else:
        ...
        profiles_surface[0] = np.column_stack((profiles_surface[0], pg.analysis.profile_dens(s.gas, 'mass', r_edges=bins, proj=1)))
        profiles_surface[1] = np.column_stack((profiles_surface[1], pg.analysis.profile_dens(s.gas[hot], 'mass', r_edges=bins, proj=1)))
        profiles_surface[2] = np.column_stack((profiles_surface[2], pg.analysis.profile_dens(s.gas[~hot], 'mass', r_edges=bins, proj=1)))
        profiles_surface[3] = np.column_stack((profiles_surface[3], pg.analysis.profile_dens(s.gas[m_rec], 'mass', r_edges=bins, proj=1)))
        profiles_surface[4] = np.column_stack((profiles_surface[4], pg.analysis.profile_dens(s.gas[m_rec][hot], 'mass', r_edges=bins, proj=1)))
        profiles_surface[5] = np.column_stack((profiles_surface[5], pg.analysis.profile_dens(s.gas[m_rec][~hot], 'mass', r_edges=bins, proj=1)))
        profiles_surface[6] = np.column_stack((profiles_surface[6], pg.analysis.profile_dens(s.gas[m_nrec], 'mass', r_edges=bins, proj=1)))
        profiles_surface[7] = np.column_stack((profiles_surface[7], pg.analysis.profile_dens(s.gas[m_nrec][hot], 'mass', r_edges=bins, proj=1)))
        profiles_surface[8] = np.column_stack((profiles_surface[8], pg.analysis.profile_dens(s.gas[m_nrec][~hot], 'mass', r_edges=bins, proj=1)))
        HI_profiles_surface[0] = np.column_stack((HI_profiles_surface[0], pg.analysis.profile_dens(s.gas, 'HI', r_edges=bins, proj=1)))
        HI_profiles_surface[1] = np.column_stack((HI_profiles_surface[1], pg.analysis.profile_dens(s.gas[m_rec], 'HI', r_edges=bins, proj=1)))
        HI_profiles_surface[2] = np.column_stack((HI_profiles_surface[2], pg.analysis.profile_dens(s.gas[m_nrec], 'HI', r_edges=bins, proj=1)))
        MgII_profiles_surface[0] = np.column_stack((MgII_profiles_surface[0], pg.analysis.profile_dens(s.gas, 'MgII', r_edges=bins, proj=1)))
        MgII_profiles_surface[1] = np.column_stack((MgII_profiles_surface[1], pg.analysis.profile_dens(s.gas[m_rec], 'MgII', r_edges=bins, proj=1)))
        MgII_profiles_surface[2] = np.column_stack((MgII_profiles_surface[2], pg.analysis.profile_dens(s.gas[m_nrec], 'MgII', r_edges=bins, proj=1)))
        OVI_profiles_surface[0] = np.column_stack((OVI_profiles_surface[0], pg.analysis.profile_dens(s.gas, 'OVI', r_edges=bins, proj=1)))
        OVI_profiles_surface[1] = np.column_stack((OVI_profiles_surface[1], pg.analysis.profile_dens(s.gas[m_rec], 'OVI', r_edges=bins, proj=1)))
        OVI_profiles_surface[2] = np.column_stack((OVI_profiles_surface[2], pg.analysis.profile_dens(s.gas[m_nrec], 'OVI', r_edges=bins, proj=1)))
...
ax1.plot(bins[:-1], np.percentile(profiles_surface[0], 50, axis=1), color='b', label='total')
ax1.plot(bins[:-1], np.percentile(profiles_surface[1], 50, axis=1), color='b', ls='-.', lw=2, label='total T>10^5.2 K')
ax1.plot(bins[:-1], np.percentile(profiles_surface[2], 50, axis=1), color='b', ls='dashed', label='total T<=10^5.2 K')
ax1.plot(bins[:-1], np.percentile(profiles_surface[3], 50, axis=1), color='r', label='recycled')
ax1.plot(bins[:-1], np.percentile(profiles_surface[6], 50, axis=1), color='g', label='non recycled')
ax1.fill_between(bins[:-1], np.percentile(profiles_surface[0], 25, axis=1),
    np.percentile(profiles_surface[0], 75, axis=1), alpha=.25, color='b')
ax1.fill_between(bins[:-1], np.percentile(profiles_surface[3], 25, axis=1),
    np.percentile(profiles_surface[3], 75, axis=1), alpha=.25, color='r')
ax1.fill_between(bins[:-1], np.percentile(profiles_surface[6], 25, axis=1),
    np.percentile(profiles_surface[6], 75, axis=1), alpha=.25, color='g')
ax1.legend(loc='upper right', fontsize=20)

ax3.plot(bins[:-1], np.percentile(HI_profiles_surface[0], 50, axis=1), color='b', label='total')
ax3.plot(bins[:-1], np.percentile(HI_profiles_surface[1], 50, axis=1), color='r', label='recycled')
ax3.plot(bins[:-1], np.percentile(HI_profiles_surface[2], 50, axis=1), color='g', label='non recycled')
ax3.fill_between(bins[:-1], np.percentile(HI_profiles_surface[0], 25, axis=1),
    np.percentile(HI_profiles_surface[0], 75, axis=1), alpha=.25, color='b')
ax3.fill_between(bins[:-1], np.percentile(HI_profiles_surface[1], 25, axis=1),
    np.percentile(HI_profiles_surface[1], 75, axis=1), alpha=.25, color='r')
ax3.fill_between(bins[:-1], np.percentile(HI_profiles_surface[2], 25, axis=1),
    np.percentile(HI_profiles_surface[2], 75, axis=1), alpha=.25, color='g')

ax5.plot(bins[:-1], np.percentile(MgII_profiles_surface[0], 50, axis=1), color='b', label='total')
ax5.plot(bins[:-1], np.percentile(MgII_profiles_surface[1], 50, axis=1), color='r', label='recycled')
ax5.plot(bins[:-1], np.percentile(MgII_profiles_surface[2], 50, axis=1), color='g', label='non recycled')
ax5.fill_between(bins[:-1], np.percentile(MgII_profiles_surface[0], 25, axis=1),
    np.percentile(MgII_profiles_surface[0], 75, axis=1), alpha=.25, color='b')
ax5.fill_between(bins[:-1], np.percentile(MgII_profiles_surface[1], 25, axis=1),
    np.percentile(MgII_profiles_surface[1], 75, axis=1), alpha=.25, color='r')
ax5.fill_between(bins[:-1], np.percentile(MgII_profiles_surface[2], 25, axis=1),
    np.percentile(MgII_profiles_surface[2], 75, axis=1), alpha=.25, color='g')

ax7.plot(bins[:-1], np.percentile(OVI_profiles_surface[0], 50, axis=1), color='b', label='total')
ax7.plot(bins[:-1], np.percentile(OVI_profiles_surface[1], 50, axis=1), color='r', label='recycled')
ax7.plot(bins[:-1], np.percentile(OVI_profiles_surface[2], 50, axis=1), color='g', label='non recycled')
ax7.fill_between(bins[:-1], np.percentile(OVI_profiles_surface[0], 25, axis=1),
    np.percentile(OVI_profiles_surface[0], 75, axis=1), alpha=.25, color='b')
ax7.fill_between(bins[:-1], np.percentile(OVI_profiles_surface[1], 25, axis=1),
    np.percentile(OVI_profiles_surface[1], 75, axis=1), alpha=.25, color='r')
...
ax[0].plot(bins[:-1], np.percentile(profiles_surface[0], 50, axis=1), color='b', label='total')
ax[0].plot(bins[:-1], np.percentile(profiles_surface[1], 50, axis=1), color='b', ls='-.', lw=2, label=r'total $T>10^{5.2}$ K')
ax[0].plot(bins[:-1], np.percentile(profiles_surface[2], 50, axis=1), color='b', ls='dashed', label=r'total $T\leq10^{5.2}$ K')
ax[0].fill_between(bins[:-1], np.percentile(profiles_surface[0], 25, axis=1),
    np.percentile(profiles_surface[0], 75, axis=1), alpha=.25, color='b')
ax[1].plot(bins[:-1], np.percentile(profiles_surface[3], 50, axis=1), color='r', label='recycled')
ax[1].plot(bins[:-1], np.percentile(profiles_surface[4], 50, axis=1), color='r', ls='-.', lw=2, label=r'recycled $T>10^{5.2}$ K')
ax[1].plot(bins[:-1], np.percentile(profiles_surface[5], 50, axis=1), color='r', ls='dashed', label=r'recycled $T\leq10^{5.2}$ K')
ax[1].fill_between(bins[:-1], np.percentile(profiles_surface[3], 25, axis=1),
    np.percentile(profiles_surface[3], 75, axis=1), alpha=.25, color='r')
ax[2].plot(bins[:-1], np.percentile(profiles_surface[6], 50, axis=1), color='g', label='non recycled')
ax[2].plot(bins[:-1], np.percentile(profiles_surface[7], 50, axis=1), color='g', ls='-.', lw=2, label=r'non recycled $T>10^{5.2}$ K')
ax[2].plot(bins[:-1], np.percentile(profiles_surface[8], 50, axis=1), color='g', ls='dashed', label=r'non recycled $T\leq10^{5.2}$ K')
ax[2].fill_between(bins[:-1], np.percentile(profiles_surface[6], 25, axis=1),
    np.percentile(profiles_surface[6], 75, axis=1), alpha=.25, color='g')
...
plt.savefig(filename.split("/")[-1][:-3] + "_surface_all_gas_only.png", bbox_inches='tight')
